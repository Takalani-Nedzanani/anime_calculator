...
import 'package:anime_calculator/constant/colors.dart';
import 'package:anime_calculator/provider/cal_provider.dart';
import 'package:anime_calculator/screens/widgets_data.dart';
import 'package:anime_calculator/widgets/cal_button.dart';
import 'package:anime_calculator/widgets/textfield.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CalculatorProvider>(builder: (context, provider, _) {
      return Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Anime Calculator"),
          backgroundColor: Colors.black,
        ),
        body: Column(
          children: [
